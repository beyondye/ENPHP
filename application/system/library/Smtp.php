...
class Smtp
{
     ...
     * @param array $config
     *
     * @subparam string $config ['server'] 代理服务器的ip或者域名
     * @subparam string $config ['username'] 认证账号
     * @subparam string $config ['password'] 认证密码
     * @subparam int $config ['port'] 代理服务器的端口，smtp默认25号端口
     *
     */
